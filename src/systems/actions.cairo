use tonatuna::models::Direction;
use tonatuna::models::Position;

// define the interface
#[starknet::interface]
trait IActions<TContractState> {
    fn go_fishing(self: @TContractState, name: felt252, fishing_style: u8);
    ...
    fn upgrade_equipment(self: @TContractState, equipment_type: u8);
